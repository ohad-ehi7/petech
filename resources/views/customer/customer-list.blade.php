                        ...
                        @forelse($customers as $customer)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    {{-- Le bouton Modifier est toujours affiché --}}
                                    <a href="{{ route('customers.edit', $customer) }}"
                                        class="text-blue-600 hover:text-blue-900 mr-3">Modifier</a>

                                    {{-- Le bouton Supprimer est caché si le client est "Cash" --}}
                                    @if (strtolower($customer->fullname) !== 'cash')
                        ...
                        @empty
                            <tr>
                                <td colspan="5"
                                    ...
                                    Aucun client trouvé. <a href="{{ route('customers.create') }}"
                                        class="text-blue-600 hover:text-blue-900">Ajoutez-en un maintenant</a>
                                </td>
                            </tr>
                        @endforelse
