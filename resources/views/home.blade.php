...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <div class="mr-64">
  ...
  <div class="flex">
    ...
    <main class="ml-64 w-full space-y-6">

      <!-- Profile section -->
      <div class="flex items-center p-4 bg-white border border-gray-200 shadow  bg-cover bg-center" style="background-image: url('images/small-background.png');">
   ...
   <div class="grid grid-cols-5 grid-rows-8 ">
    <div class="col-span-3 row-span-2 -ml-34">
    <div class="max-w-3xl mx-auto rounded-lg overflow-hidden shadow border border-gray-200">
         ...
         <div class="col-span-2 row-span-2 col-start-4 p-4 -mt-4 -ml-28 mr-8">
      ...
      <div class="col-span-2 row-span-2 row-start-3 p-10 -mt-28">
      <div class="rounded-lg shadow-md overflow-hidden">
...
<div class="col-span-3 row-span-2 col-start-3 row-start-3 -mt-18 mr-10">
  <div class="rounded-lg shadow-md overflow-hidden">
    <!-- Header -->
...
<div class="row-span-2 row-start-5 p-10 -mt-38">
  <!-- Purchase Order Card -->
...
<div class="col-span-4 row-span-2 row-start-5 p-10 -mt-38">
  <!-- Sales History Card -->
